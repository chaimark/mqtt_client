 ...
 *initial documentation Ian Craggs - documentation and platform specific header
...
/* The following sequence of macros converts the MQTTCLIENT_PLATFORM_HEADER
...
/** MQTT Publish - send an MQTT publish packet and wait for all acks to complete
 * for all QoSs
 ...
 *  @param messageHandler - pointer to the message handler function or NULL to
 * remove
 *  @return success code
 */
...
#if defined(MQTT_TASK)
/** MQTT start background thread for a client.  After this, MQTTYield should not
 * be called.
 *  @param client - the client object to use
 *  @return success code
 */
